export default [
    {
        ...
        items:
            [
                ...
                { name: 'houseModel', source: '/assets/houseModel.glb' },
                { name: 'houseTexture', source: '/assets/houseTexture.jpg', type: 'texture' },
                { name: 'cakeTexture', source: '/assets/cakeTexture.jpg', type: 'texture' },
